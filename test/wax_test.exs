defmodule WaxTest do
  ...
  # FIXME: update when the example is updated in spec
  ...
  #    test_data = %{
  #    rawId: "iqCXEfJ-dEoBlWqIl0iq2p_gj13HSg7r_MA7xOcOiO8RkCrYNmQHIjV9yhZVASr87cUsflo7DNuuvGsnrlTl1ig",
  ...
  #  test "Invalid safetynet attestation statement (invalid sig)" do
  #    # from https://fidoalliance.org/specs/fido-v2.0-rd-20180702/fido-server-v2.0-rd-20180702.html#android-attesation
  #    # note that this example is invalid because the client data does not have a `type`
  #    test_data = %{
  #    rawId: "iqCXEfJ-dEoBlWqIl0iq2p_gj13HSg7r_MA7xOcOiO8RkCrYNmQHIjV9yhZVASr87cUsflo7DNuuvGsnrlTl1ig",
  ...
  #      |> :erlang.iolist_to_binary
  #
  #    assert {:error, :attestation_android_safetynet_invalid_signature} ==
  #      Wax.new_credential_verify(attestation_object, client_data_json, challenge)
  #  end
